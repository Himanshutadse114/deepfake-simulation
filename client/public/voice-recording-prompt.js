(() => {
  ...
  if (!recorder || recorder.dataset.scriptPromptReady === 'true') return;
  recorder.dataset.scriptPromptReady = 'true';

  const title = Array.from(recorder.children).find((el) => el.tagName === 'B');
  ...
  style.textContent = `
    ...
    @media(max-width:700px){
      ...
      #recordContainer>div:first-child{
